describe('Responsiveness tests for the "History of Changes" subpage on various mobile devices', () => {
    const devices = [
        "ipad-mini",
        "iphone-6",
        "iphone-8",
    ...
    devices.forEach((device) => {
        context(`Responsiveness test on the device ${device}`, () => {
            ...
            it('It should display key page elements of "History of Changes" subpage (navbar, header, product features, footer)', () => {
