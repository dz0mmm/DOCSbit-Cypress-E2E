describe('Tests of UI elements on the DOCSbit "Custom Styling" page', () => {
    beforeEach(() => {
    ...
    it('A custom styling section should be visible on the page', () => {
        cy.get("main > .bg-light > .container").should("be.visible");
    });

    it('Displays the main custom styling section title', () => {
        cy.get("h1").should("be.visible").and("contain", "Custom styling");
    });

    it('Displays the paragraphs and links of custom styling section', () => {
