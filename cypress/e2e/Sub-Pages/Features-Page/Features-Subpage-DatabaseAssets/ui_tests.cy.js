describe('Tests of UI elements on the DOCSbit "Database Assets" page', () => {
    beforeEach(() => {
    ...
    it('A database assets section should be visible on the page', () => {
        cy.get("main > .bg-light > .container").should("be.visible");
    });

    it('Displays the main database assets section title', () => {
        cy.get("h1").should("be.visible").and("contain", "Database assets");
    });

    it('Displays the paragraphs and links of database assets section', () => {
