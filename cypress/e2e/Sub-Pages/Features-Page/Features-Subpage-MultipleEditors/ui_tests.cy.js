describe('Tests of UI elements on the DOCSbit multiple editors page', () => {
    ...
    it('A multiple editors section should be visible on the page', () => {
        cy.get("main > .bg-light > .container").should("be.visible");
    });

    it('Displays the main multiple editors section title', () => {
        cy.get("h1").should("be.visible").and("contain", "Multiple Editors");
    });

    it('Displays the paragraphs and links of multiple editors section', () => {
