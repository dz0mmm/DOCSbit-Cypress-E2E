describe('Tests of UI elements on the DOCSbit "Sharing" subpage', () => {
    beforeEach(() => {
    ...
    it('A sharing section should be visible on the page', () => {
        cy.get("main > .bg-light > .container").should("be.visible");
    });

    it('Displays the main sharing section title', () => {
        cy.get("h1").should("be.visible").and("contain", "Sharing");
    });

    it('Displays the paragraphs and links of sharing section', () => {
