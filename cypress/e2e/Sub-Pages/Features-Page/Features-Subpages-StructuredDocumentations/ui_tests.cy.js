describe('Tests of UI elements on the DOCSbit "Structured Documentations" subpage', () => {
    beforeEach(() => {
    ...
    it('A structured documentations section should be visible on the page', () => {
        cy.get("main > .bg-light > .container").should("be.visible");
    });

    it('Displays the main structured documentations section title', () => {
        cy.get("h1").should("be.visible").and("contain", "Stuctured Documentations");
    });

    it('Displays the paragraphs and links of structured documentations section', () => {
        ...
        cy.get(":nth-child(7) > .card-body").should("exist");
        cy.get(".single-post-text > :nth-child(8)").should("be.visible");
    });
