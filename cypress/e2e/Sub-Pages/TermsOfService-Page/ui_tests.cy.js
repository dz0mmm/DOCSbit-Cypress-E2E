describe('Tests of UI elements on the DOCSbit terms of service page', () => {
    ...
    it('A product privacy policy section should be visible on the page', () => {
        cy.get(".bg-white > .container").should("be.visible");
    });

    it('Displays the main terms of service section title', () => {
        cy.get("h1").should("be.visible").and("contain", "Terms of service");
    });

    it('Displays the contents of the terms of service section', () => {
